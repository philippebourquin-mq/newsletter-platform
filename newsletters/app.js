...
async function testGithubConnection(){
  ...
  const testUrl=`https://api.github.com/repos/${cfg.owner}/${cfg.repo}/contents/newsletters/${NEWSLETTER_SLUG}/sources.json?ref=${cfg.branch}`;
  try{
...
async function _autoFeedback(){
  ...
  const result=await githubPushFile(
    `newsletters/${NEWSLETTER_SLUG}/feedback_ui.json`,
    payload,
...
async function pushSourcesToGitHub(){
  ...
  const result=await githubPushFile(
    `newsletters/${NEWSLETTER_SLUG}/sources.json`,
    data,
